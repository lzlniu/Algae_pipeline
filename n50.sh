...
assembly=$1
mkdir temp;
#get contig lengths, ordered from large to small; 1. remove newlines in sequences, 2. remove fasta headers, 3. get contig sizes (line lengths) and order them from large to small.
