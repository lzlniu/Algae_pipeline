#BSUB -L /bin/bash
#BSUB -J blast_FDES192082103-1a_L4.sh
#BSUB -q fat
#BSUB -n 4
#BSUB -o blast_FDES192082103-1a_L4.out
#BSUB -e blast_FDES192082103-1a_L4.err

#mkdir FDES192082103-1a_L4
cd FDES192082103-1a_L4
...
makeblastdb -in FDES192082103-1a_L4-p_consensusScaffold.fa -dbtype nucl -parse_seqids -out scaf
...
awk '!/^>/ { printf "%s", $0; n = "\n" } /^>/ { print n $0; n = "" } END { printf "%s", n }' FDES192082103-1a_L4-p_consensusScaffold.fa > p_oneline_scaf.fa
...
mkdir FDES192082103-1a_L4-p_circos
cd FDES192082103-1a_L4-p_circos
mkdir data
mkdir etc
cd ..
...
for scafnamesel2 in $(cat scafname-sel); do
	...
	awk '{print "chr1\t"$10"\t"$11"\tfill_color=chr'"$chrcolor"'"}' p_mt_spp-${scafnamesel2}.txt >> FDES192082103-1a_L4-p_circos/data/highlights.1.txt
	awk '{print "chr1\t"$10"\t"$11"\t"$5}' p_mt_spp-${scafnamesel2}.txt >> FDES192082103-1a_L4-p_circos/data/labels.1.txt
	let chrcolor=chrcolor+1
	rm -rf p_mt_spp-${scafnamesel2}.txt
done
#awk '{print "chr1\t"$10"\t"$11"\tfill_color=green"}' p_mt_sppA.txt > FDES192082103-1a_L4-p_circos/data/highlights.1.txt
#awk '{print "chr1\t"$10"\t"$11"\t"$5}' p_mt_sppA.txt > FDES192082103-1a_L4-p_circos/data/labels.1.txt
awk 'NR==1{print "chr\t-\tchr1\t"$1".mtDNA.circos.by.Zelin.Li\t0\t"$2"\tchry"}' p_mt_spp.txt > FDES192082103-1a_L4-p_circos/data/mtDNAideogram.txt
#rm -rf p_mt_sppA.txt
rm -rf scafname-sel
...
" > FDES192082103-1a_L4-p_circos/etc/circos.conf
echo "
<highlights>
<highlight>
...
" > FDES192082103-1a_L4-p_circos/etc/highlights.conf
echo "
<ideogram>
<spacing>
default = 0.005r
...
" > FDES192082103-1a_L4-p_circos/etc/ideogram.conf
echo "
show_ticks          = yes
...
" > FDES192082103-1a_L4-p_circos/etc/ticks.conf
find . -name "*" -type f -size 0c | xargs -n 1 rm -f
/public/home/lizelin/assembly/circos-0.69-9/bin/circos -conf ./FDES192082103-1a_L4-p_circos/etc/circos.conf
rm -rf FDES192082103-1a_L4-p_circos
mv circos.png FDES192082103-1a_L4-p_mt.png
mv circos.svg FDES192082103-1a_L4-p_mt.svg
